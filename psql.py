...
def insert_user(user):
    ...
    sql = "insert into users (id,symptom,gender,age,diagnosis,first_name,last_name,profile_pic,question_count) VALUES("+str(user.id)+",'"+str(user.symptom)+"','"+str(user.gender)+"',"+str(user.age)+",'"+json.dumps(user.diagnosis)+"','"+str(user.first_name).replace("'", "")+"','"+str(user.last_name).replace("'", "")+"','"+str(user.profile_pic)+"',"+str(user.question_count)+")"
    conn = None
    try:
...
def update_user(id, user):
    ...
    try:
        ...
        cur.execute("update users set symptom = '"+str(user.symptom)+"',gender = '"+str(user.gender)+"',age = "+str(user.age)+",diagnosis = '"+json.dumps(user.diagnosis)+"',first_name = '"+str(user.first_name)+"',last_name = '"+str(user.last_name)+"',profile_pic = '"+str(user.profile_pic)+"',question_count = "+str(user.question_count)+"  where id = "+str(id))
